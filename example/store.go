...
// Generated on: 2020-12-26 15:27:50.146988752 -0800 PST m=+0.002047579
package example
...
// Retrieves all emails from the users table
func GetUserListWithModelScan(db *sql.DB, limit int, offset int) (*GetUserListWithModelResult, error) {
...
func GetUserListWithModel(db *sql.DB, limit int, offset int) ([]User, error) {
	res, err := GetUserListWithModelScan(db, limit, offset)
	if err != nil {
		return nil, err
	}
	defer res.Close()
